...
module RJava
  module ObjectJavaCompatibility
    def get_class
      self.class
    end
  ...
  module ModuleJavaCompatibility
    def get_name
      parts = name.split "::"
  ...
  module StringJavaCompatibility
    ...
    def self.included(mod)
      mod.module_eval do
        ...
        alias_method :ruby_replace, :replace
...
class Object
  include RJava::ObjectJavaCompatibility
end

class Module
  include RJava::ModuleJavaCompatibility
end

class Class
  include RJava::ClassJavaCompatibility
end

class String
  include RJava::StringJavaCompatibility
end
